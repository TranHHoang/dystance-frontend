...
// const mock = new MockAdapter(Axios.create(), { delayResponse: 1000 });

// // Username & password
// mock.onPost("/api/rooms/create").reply((config: AxiosRequestConfig) => {
...
// mock.onPost(`${hostName}/api/users/login`).reply((config: AxiosRequestConfig) => {
//   const params = config.data as FormData;
//   console.log(config.data);
//   console.log(config.headers);
...
// mock.onPost(`${hostName}/api/users/register`).reply((config: AxiosRequestConfig) => {
//   const params = config.data as FormData;
//   const userName = params.get("userName");
//   const email = params.get("email");
...
// mock.onPost(`${hostName}/api/users/google/updateInfo`).reply((config: AxiosRequestConfig) => {
//   const params = config.data as FormData;
//   const userName = params.get("userName");
